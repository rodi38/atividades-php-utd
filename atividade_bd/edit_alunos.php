<?php  
    ...
    $aluno = select("alunos", null, array("id_aluno"=>$_POST['id_aluno']), "");


    if(isset($_POST['id_aluno'])){
        echo "diasjdiasj";
    }else{
        echo "não está vindo aqui";
    }
    ...
    <div class="container">
        <form action="update_aluno.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?=$aluno['aluno_nome'];?>" name="aluno_nome" id="fname">
                <label for="aluno_email">Email</label>
                <input type="email" value="<?=$aluno['aluno_email'];?>" name="aluno_email" id="email">
                <label for="aluno_dtnasc">Data de Nascimento</label>
                <input type="date" value="<?=$aluno['aluno_dtnasc'];?>" name="aluno_dtnasc" id="aluno_dtnasc">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?=$aluno['aluno_cpf'];?>" name="aluno_cpf" id="aluno_cpf">
                <label for="aluno_tel">Telefone</label>
                <input type="tel" value="<?=$aluno['aluno_tel'];?>" name="aluno_tel" id="aluno_tel">

                <input type="hidden" value="<?=$aluno['id_aluno']?>"name="id_aluno" value="<?=$aluno['id_aluno'];?>">
